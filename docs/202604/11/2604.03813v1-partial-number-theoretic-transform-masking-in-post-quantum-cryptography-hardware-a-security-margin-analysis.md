...
score: 7.35
tldr: 论文关注设计任务，目标是提升效果与可用性；作者提出 ML-DSA，用于设计，并结合图结构建模；实验验证了该方法在目标任务上的有效性。
tldr_cn: 论文关注设计任务，目标是提升效果与可用性；作者提出 ML-DSA，用于设计，并结合图结构建模；实验验证了该方法在目标任务上的有效性。
...
method: 作者提出 ML-DSA，用于设计，并结合图结构建模。
