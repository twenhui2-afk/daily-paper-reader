...
tldr: "这篇工作的核心目标是提出一套投影通用方法的 Voronoi 剖分的...；一组便于处理的线性相关的与非正交的 (n+1) 向量 k_i is 被引入.；对权格的 Voronoi 剖分做投影 A_4^* 得到一种不同于...的铺砌方案..."
tldr_cn: "这篇工作的核心目标是提出一套投影通用方法的 Voronoi 剖分的...；一组便于处理的线性相关的与非正交的 (n+1) 向量 k_i is 被引入.；对权格的 Voronoi 剖分做投影 A_4^* 得到一种不同于...的铺砌方案..."
