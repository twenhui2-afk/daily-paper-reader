...
source: arxiv
title_zh: Unsupervised 4D Flow MRI Velocity Enhancement与Unwrapping 使用 Divergence-Free Neural Networks
abstract_zh: "这篇工作提出 unsupervised Divergence 与 Aliasing-Free neural 网络 (DAF-FlowNet) 用于 4D Flow Magnetic Resonance。\n\n核心做法：DAF-FlowNet parameterizes velocities as curl 的向量 potential，enforcing mass conservation by constructi。\n\n主要结果：On synthetic aortic 4D Flow MRI generated from computational fluid dynamics，DAF-FlowNet 达到d lower er。\n\n值得关注的点在于：These results support DAF-FlowNet as 框架 that unifies velocity enhancement 与 phase unwrapping to impr。"
...
score: 7.55
tldr: 围绕《Unsupervised 4D Flow MRI...》；DAF-FlowNet parameterizes veloci...；On synthetic aortic 4D Flow MRI gene...
tldr_cn: 围绕《Unsupervised 4D Flow MRI...》；DAF-FlowNet parameterizes veloci...；On synthetic aortic 4D Flow MRI gene...
...
motivation: 这篇工作提出 unsupervised Divergence 与 Aliasing-Free neural 网络 (DAF-FlowNet) 用于 4D Flow Magnetic Resonance。
method: 核心做法：DAF-FlowNet parameterizes velocities as curl 的向量 potential，enforcing mass conservation by constructi。
result: 主要结果：On synthetic aortic 4D Flow MRI generated from computational fluid dynamics，DAF-FlowNet 达到d lower er。
conclusion: 值得关注的点在于：These results support DAF-FlowNet as 框架 that unifies velocity enhancement 与 phase unwrapping to impr。
---

## 摘要
这篇工作提出 unsupervised Divergence 与 Aliasing-Free neural 网络 (DAF-FlowNet) 用于 4D Flow Magnetic Resonance。
